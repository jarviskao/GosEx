    ...
    for i = 1, GameHeroCount()do
      ...
      if hero.isEnemy and hero.alive and hero.isTargetable and GetDistanceSqr(myHero.pos, hero.pos) <= QRangeSqr then
        if CalcPhysicalDamage(myHero, hero, Qdmg) >= hero.health + hero.shieldAD then
          ControlCastSpell(HK_Q, hero, self.Q.delay)
        end
      end
    end
  end
    ...
    if missile.isEnemy and missile.team < 300 and data.target == 0 then
      ...
      if isOnSegment and GetDistanceSqr(pointSegment, myPos) < (data.width + myHero.boundingRadius) * (data.width + myHero.boundingRadius) then
        ...
        if TimeToHit < 0.3 and TimeToHit > 0.1 then
          ControlCastSpell(HK_W, myPos:Extended(data.startPos, 200))
        end
      end
    end
  end
...
self.Icons = {
  Menu = "https://i2.wp.com/img.talkandroid.com/uploads/2014/03/htc_dot_view_app_icon-450x450.png",
  Tiamat = "https://vignette2.wikia.nocookie.net/leagueoflegends/images/e/e3/Tiamat_item.png",
  RavenousHydra = "https://vignette1.wikia.nocookie.net/leagueoflegends/images/e/e8/Ravenous_Hydra_item.png",
  TitanicHydra = "https://vignette1.wikia.nocookie.net/leagueoflegends/images/2/22/Titanic_Hydra_item.png",
  YoumuusGhostblade = "https://vignette4.wikia.nocookie.net/leagueoflegends/images/4/41/Youmuu%27s_Ghostblade_item.png",
  RanduinsOmen = "https://vignette1.wikia.nocookie.net/leagueoflegends/images/0/08/Randuin%27s_Omen_item.png",
  BilgewaterCutlass = "https://vignette1.wikia.nocookie.net/leagueoflegends/images/4/44/Bilgewater_Cutlass_item.png",
  BladeoftheRuinedKing = "https://vignette2.wikia.nocookie.net/leagueoflegends/images/2/2f/Blade_of_the_Ruined_King_item.png",
  HextechGunblade = "https://vignette4.wikia.nocookie.net/leagueoflegends/images/6/64/Hextech_Gunblade_item.png"
}
      ...
      if item ~= nil and myHero:GetSpellData(i).currentCd == 0 then
        ...
        if item == 3144 then
          if self.Menu.Item.BilgewaterCutlass:Value()then
            ControlCastSpell(hotkey, target)
          end
        end
        if item == 3153 then
